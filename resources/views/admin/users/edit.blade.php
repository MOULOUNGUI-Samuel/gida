                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                               id="name" name="name" value="{{ old('name', $user->nom) }}" required>
                        @error('name')
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('role') is-invalid @enderror"
                            ...
                            <option value="Administrateur" {{ old('role', $currentRole) == 'Administrateur' ? 'selected' : '' }}>Administrateur</option>
                            <option value="Employe" {{ old('role', $currentRole) == 'Employe' ? 'selected' : '' }}>Employe</option>
                            <option value="Entreprise Support" {{ old('role', $currentRole) == 'Entreprise Support' ? 'selected' : '' }}>Entreprise Support</option>
                        </select>
                        @error('role')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('company') is-invalid @enderror"
                               id="company" name="company" value="{{ old('company', $user->code_entreprise) }}"
