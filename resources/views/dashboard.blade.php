...
@section('content')
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card compact">
            <h4>À risque</h4>
            <div class="number">{{ $stats['a_risque'] }}</div>
            <div class="trend" style="color: #dc3545;">+2 aujourd'hui</div>
        </div>
        <div class="stat-card compact">
            <h4>Clôturées</h4>
            <div class="number">{{ $stats['cloturees'] }}</div>
                ...
                <td>{{ $demande->reference }}</td>
                    ...
                    <td>
                        @if($demande->societe_assignee)
                            <span class="assigned-company">{{ $demande->societe_assignee }}</span>
                        @else
                    ...
                    <td>
                        ...
                        <button class="admin-btn secondary" onclick="assignDemande({{ $demande->id }})">Affecter</button>
