...
<div class="container-fluid p-4">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form action="<?php echo e(route('entreprises.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                               id="societe" name="societe" value="<?php echo e(old('societe')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                           id="adresse" name="adresse" value="<?php echo e(old('adresse')); ?>">
