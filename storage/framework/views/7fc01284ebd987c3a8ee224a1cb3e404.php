<?php $__env->startSection('content'); ?>
    <div class="container-fluid p-4">
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <form action="<?php echo e(route('entreprises.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="nom"
                                name="nom" value="<?php echo e(old('nom')); ?>" required>
                            <?php $__errorArgs = ['nom'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="societe"
                                name="societe" value="<?php echo e(old('societe')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3 form-check">
                        <input type="checkbox" class="form-check-input" id="active" name="active"
                            <?php echo e(old('active', true) ? 'checked' : ''); ?> value="1">
...
<?php echo $__env->make('layouts.appAdministration', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Gida\resources\views/entreprises/create.blade.php ENDPATH**/ ?>