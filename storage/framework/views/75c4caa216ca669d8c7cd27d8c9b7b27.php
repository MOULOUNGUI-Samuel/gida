...
<head>
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"></script>
    <title><?php echo e(config('app.name', 'GIDA')); ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <aside class="gida-sidebar">
        ...
        <nav>
            <ul>
                <li onclick="window.location.href='<?php echo e(route('dashboardEmployer')); ?>'">
                    <span class="icon">🏠</span>
                    <span>Dashboard</span>
                </li>
                <li onclick="window.location.href='<?php echo e(route('nouvelledemande')); ?>'">
                    <span class="icon">➕</span>
                    <span>Nouvelle Demande</span>
                </li>
                <li onclick="window.location.href='<?php echo e(route('historique')); ?>'">
                    <span class="icon">📄</span>
...
<?php /**PATH C:\laragon\www\FCI2notif\FCI2\resources\views/layouts/appEmployer.blade.php ENDPATH**/ ?>