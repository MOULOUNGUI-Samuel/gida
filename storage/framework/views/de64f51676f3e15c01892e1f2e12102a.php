...
unset($__errorArgs, $__bag); ?>" id="name"
                                name="name" value="<?php echo e(old('name', $user->nom)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="role" name="role"
                                ...
                                <option value="Administrateur"
                                    <?php echo e(old('role', $currentRole) == 'Administrateur' ? 'selected' : ''); ?>>Administrateur
                                </option>
                                <option value="Employe" <?php echo e(old('role', $currentRole) == 'Employe' ? 'selected' : ''); ?>>
                                    Employe</option>
                                <option value="Entreprise Support"
                                    <?php echo e(old('role', $currentRole) == 'Entreprise Support' ? 'selected' : ''); ?>>Entreprise
                                    Support</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>" id="company"
                                name="company" value="<?php echo e(old('company', $user->code_entreprise)); ?>"
...
unset($__errorArgs, $__bag); ?>" id="entreprise_id"
                                name="entreprise_id">
