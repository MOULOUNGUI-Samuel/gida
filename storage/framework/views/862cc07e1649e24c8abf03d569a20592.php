...
<div class="container-fluid p-4">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form action="<?php echo e(route('entreprises.update', $entreprise->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                               id="code" name="code" value="<?php echo e(old('code', $entreprise->code)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                               id="nom" name="nom" value="<?php echo e(old('nom', $entreprise->nom)); ?>" required>
                        <?php $__errorArgs = ['nom'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>"
                               id="societe" name="societe" value="<?php echo e(old('societe', $entreprise->societe)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                               id="email" name="email" value="<?php echo e(old('email', $entreprise->email)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                           id="adresse" name="adresse" value="<?php echo e(old('adresse', $entreprise->adresse)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                              id="description" name="description" rows="4"><?php echo e(old('description', $entreprise->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3 form-check">
                    <input type="checkbox" class="form-check-input" id="active" name="active"
                           <?php echo e(old('active', $entreprise->active) ? 'checked' : ''); ?>>
