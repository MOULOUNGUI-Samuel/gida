...
<?php $__env->startSection('title', 'Évaluation - GIDA'); ?>

<?php $__env->startSection('content'); ?>
    <!-- HEADER UTILISATEUR + CTA -->
    <div class="gida-header" id="gida-header">
        <h1>Évaluation de satisfaction</h1>
        <button class="gida-btn" onclick="window.location.href='<?php echo e(route('dashboardEmployer')); ?>'">
    ...
    <section class="gida-form-section" id="section-eval" aria-label="Évaluation satisfaction">
        <div class="evaluation-container">
            ...
            <form action="<?php echo e(route('evaluations.store')); ?>" method="POST" class="evaluation-form" id="evaluationForm">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="demande_id" value="<?php echo e($demandeId ?? ''); ?>">
                ...
                <div class="form-card">
                    <div class="form-group">
                        ...
                        <textarea id="commentaire" name="commentaire" 
                            ...
                            rows="4"
                            maxlength="1000"><?php echo e(old('commentaire')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            <?php if(old('note')): ?>
                const selectedValue = "<?php echo e(old('note')); ?>";
...
<?php echo $__env->make('layouts.appEmployer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\FCI2notif\FCI2\resources\views/components/employer/Evaluation.blade.php ENDPATH**/ ?>